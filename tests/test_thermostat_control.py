...
class TestTemperatureControl:
    ...
    @pytest.mark.asyncio
    async def test_config_disable_key_lock_plus_not_connected(self, thermostat, mock_mqtt_client):
        thermostat._connected = False
        with pytest.raises(ConnectionError):
            await thermostat.disable_key_lock_plus()
    ...
    @pytest.mark.asyncio
    async def test_config_disable_key_lock_not_connected(self, thermostat, mock_mqtt_client):
        thermostat._connected = False
        with pytest.raises(ConnectionError):
            await thermostat.disable_key_lock()
    ...
    @pytest.mark.asyncio
    async def test_config_disable_mirrored_display_not_connected(self, thermostat, mock_mqtt_client):
        thermostat._connected = False
        with pytest.raises(ConnectionError):
            await thermostat.disable_mirrored_display()
